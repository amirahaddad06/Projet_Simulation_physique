...
pygame.display.set_caption("Suivi de trajectoire droite – robot idéal vs moteur")
...
while running:
    ...
    # 6. Trace la trajectoire droite
    for i in range(500):
        x, y = trajectory_line(i * 0.01)
